...
class UserPreferences:
    ...
    home_type: str | None = None  # "Single Wide", "Double Wide", "Modular"
...
class ConversationContext:
    ...
    last_search_query: dict | None = None
    ...
    def update_from_message(self, message: str, search_results: list[dict] | None = None):
        ...
        if any(
            word in message_lower for word in ["appointment", "visit", "see it", "tour", "showing"]
        ):
    ...
    def _number_word_to_int(self, text: str) -> int | None:
...
class ConversationMemory:
    ...
    async def get_context(self, session_id: str, user_id: str) -> ConversationContext:
        ...
        if doc.exists:
            ...
            context = ConversationContext(
                session_id=session_id, user_id=user_id, preferences=UserPreferences()
            )
            return context
    ...
    async def save_context(self, context: ConversationContext):
        ...
        def _save():
            doc_ref.set(context.to_dict(), timeout=firestore_timeout())
