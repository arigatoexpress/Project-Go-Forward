...
multiple inventory items. Aggregates `image_url`, `hero_image`,
`gallery_images`/`photos`, and `floorplan_url` fields and reports any
URL that appears in 2+ inventory documents.
...
def run_photo_dedup_audit(inventory: Iterable[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    """
    index = build_url_index(inventory)
